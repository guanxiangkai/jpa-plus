package com.actomize.jpa.plus.autofill.handler;

import com.actomize.jpa.plus.autofill.annotation.CreateBy;
import com.actomize.jpa.plus.autofill.annotation.CreateTime;
import com.actomize.jpa.plus.autofill.annotation.UpdateBy;
import com.actomize.jpa.plus.autofill.annotation.UpdateTime;
...
public class AutoFillFieldHandler implements FieldHandler {
    ...
    public void beforeSave(Object entity, Field field) {
        try {
            ...
            log.error("自动填充失败: field={}", field.getName(), e);
        }
    }
