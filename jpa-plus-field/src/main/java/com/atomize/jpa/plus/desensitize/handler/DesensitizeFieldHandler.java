package com.atomize.jpa.plus.desensitize.handler;

import com.atomize.jpa.plus.core.field.FieldHandler;
import com.atomize.jpa.plus.core.util.ReflectionUtils;
import com.atomize.jpa.plus.desensitize.annotation.Desensitize;
import com.atomize.jpa.plus.desensitize.annotation.DesensitizeStrategy;
 ...
 * 在查询后执行掩码处理。掩码算法封装在 {@link DesensitizeStrategy}
 * 枚举中，遵循开闭原则。</p>
 *
