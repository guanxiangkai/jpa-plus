package com.actomize.jpa.plus.datasource.listener;

import com.actomize.jpa.plus.datasource.event.DataSourceChangeEvent;
 ...
 * <h3>触发刷新的方式</h3>
 * <ol>
 *   <li><b>编程式触发</b> —— 注入 {@link com.actomize.jpa.plus.datasource.refresh.DataSourceRefresher}
