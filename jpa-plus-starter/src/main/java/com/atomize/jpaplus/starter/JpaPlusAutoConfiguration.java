package com.atomize.jpaplus.starter;

import com.atomize.jpaplus.core.executor.DefaultJpaPlusExecutor;
...
import com.atomize.jpaplus.desensitize.handler.DesensitizeFieldHandler;
import com.atomize.jpaplus.dict.handler.DictFieldHandler;
...
import com.atomize.jpaplus.query.context.FlushStrategy;
import com.atomize.jpaplus.query.executor.DefaultQueryExecutor;
import com.atomize.jpaplus.query.executor.QueryExecutor;
import com.atomize.jpaplus.query.pagination.PaginationOptimizer;
import com.atomize.jpaplus.query.resolver.DefaultJpaRelationResolver;
import com.atomize.jpaplus.query.resolver.JpaRelationResolver;
import com.atomize.jpaplus.sensitive.handler.SensitiveWordHandler;
import com.atomize.jpaplus.sensitive.spi.SensitiveWordProvider;
import com.atomize.jpaplus.starter.repository.JpaPlusRepositoryFactoryBean;
import com.atomize.jpaplus.version.handler.VersionFieldHandler;
    ...
    public JpaPlusExecutor jpaPlusExecutor(InterceptorChain interceptorChain,
        ...
        InterceptorChain.CoreExecution coreExecution = invocation -> switch (invocation.type()) {
            case QUERY -> {
                ...
                if (ctx instanceof com.atomize.jpaplus.query.context.QueryContext queryContext) {
