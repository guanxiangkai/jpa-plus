package com.atomize.jpaplus.core.spi;
 ...
 *   <li>支持排序：实现类可通过 {@link com.atomize.jpaplus.core.field.FieldHandler#order()} 或
 *       {@link com.atomize.jpaplus.core.interceptor.DataInterceptor#order()} 控制优先级</li>
 * </ul>
 * </p>
 *
...
public final class JpaPlusLoader {
    ...
    private static int getOrder(Object instance) {
        return switch (instance) {
            case com.atomize.jpaplus.core.field.FieldHandler fh -> fh.order();
            case com.atomize.jpaplus.core.interceptor.DataInterceptor di -> di.order();
