package com.actomize.jpa.plus.interceptor.orderby.interceptor;
...
import com.actomize.jpa.plus.interceptor.orderby.annotation.AutoOrderBy;
import com.actomize.jpa.plus.interceptor.orderby.enums.Direction;
    ...
    public Object intercept(DataInvocation invocation, Chain chain) throws Throwable {
        if (invocation instanceof QueryInvocation qi && qi.queryContext() instanceof QueryContext ctx) {
            ...
            List<OrderByMeta> metas = cache.computeIfAbsent(
                    qi.entityClass(), this::resolveOrderByMetas
            );
